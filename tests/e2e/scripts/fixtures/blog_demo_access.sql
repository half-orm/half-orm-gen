...
\restrict lAzBKpFVxq4Lncdg5NADEXdMieEnGBSd9Hf0X30gA3eClcK73jtCfYzNyJdhx1H
...
INSERT INTO "half_orm_meta.api".access VALUES ('19c43512-b40e-4e94-be82-b3fc8823a6d1', 'anonymous', 'half_orm_meta.identity', 'user', 'GET') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".access VALUES ('15c51cc1-d55a-463c-bd48-1aa1003eb036', 'connected', 'half_orm_meta.identity', 'user', 'GET') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".access VALUES ('b57a9e38-7e73-4257-bef1-0b8b87917d43', 'admin', 'half_orm_meta.identity', 'user', 'DELETE') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".access VALUES ('b700de1f-e953-4e4c-bb7e-09708ef694a3', 'post_author', 'blog', 'post', 'PUT') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".access VALUES ('473363f5-b97c-42d8-8513-b5c4f555c20f', 'post_author', 'blog', 'post', 'DELETE') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".access VALUES ('89812a24-7da0-40a6-a552-e5415befbca8', 'connected', 'blog', 'comment', 'POST') ON CONFLICT DO NOTHING;
...
INSERT INTO "half_orm_meta.api".field_access_fk_auto VALUES ('9edf9562-de80-43b0-b9e1-606238fcc56a', '89812a24-7da0-40a6-a552-e5415befbca8', 'post_id', 'context') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".field_access_fk_auto VALUES ('0897f747-9d96-48c2-8d9a-c2a5c1a3f76a', '89812a24-7da0-40a6-a552-e5415befbca8', 'author_id', 'connected_user') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".field_access_fk_auto VALUES ('6fdf955c-3107-4ef3-b864-eccf10d491f6', '89812a24-7da0-40a6-a552-e5415befbca8', 'comment_type', 'select') ON CONFLICT DO NOTHING;
...
INSERT INTO "half_orm_meta.api".field_access_in VALUES ('b700de1f-e953-4e4c-bb7e-09708ef694a3', 'content') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".field_access_in VALUES ('b700de1f-e953-4e4c-bb7e-09708ef694a3', 'published') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".field_access_in VALUES ('b700de1f-e953-4e4c-bb7e-09708ef694a3', 'title') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".field_access_in VALUES ('89812a24-7da0-40a6-a552-e5415befbca8', 'author_id') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".field_access_in VALUES ('89812a24-7da0-40a6-a552-e5415befbca8', 'comment_type') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".field_access_in VALUES ('89812a24-7da0-40a6-a552-e5415befbca8', 'content') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".field_access_in VALUES ('89812a24-7da0-40a6-a552-e5415befbca8', 'post_id') ON CONFLICT DO NOTHING;
...
INSERT INTO "half_orm_meta.api".field_access_out VALUES ('19c43512-b40e-4e94-be82-b3fc8823a6d1', 'id') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".field_access_out VALUES ('19c43512-b40e-4e94-be82-b3fc8823a6d1', 'name') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".field_access_out VALUES ('15c51cc1-d55a-463c-bd48-1aa1003eb036', 'email') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".field_access_out VALUES ('b700de1f-e953-4e4c-bb7e-09708ef694a3', 'id') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".field_access_out VALUES ('b700de1f-e953-4e4c-bb7e-09708ef694a3', 'author_id') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".field_access_out VALUES ('b700de1f-e953-4e4c-bb7e-09708ef694a3', 'content') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".field_access_out VALUES ('b700de1f-e953-4e4c-bb7e-09708ef694a3', 'published') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".field_access_out VALUES ('b700de1f-e953-4e4c-bb7e-09708ef694a3', 'title') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".field_access_out VALUES ('89812a24-7da0-40a6-a552-e5415befbca8', 'id') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".field_access_out VALUES ('89812a24-7da0-40a6-a552-e5415befbca8', 'author_id') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".field_access_out VALUES ('89812a24-7da0-40a6-a552-e5415befbca8', 'comment_type') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".field_access_out VALUES ('89812a24-7da0-40a6-a552-e5415befbca8', 'content') ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".field_access_out VALUES ('89812a24-7da0-40a6-a552-e5415befbca8', 'post_id') ON CONFLICT DO NOTHING;
...
INSERT INTO "half_orm_meta.api".field_access_searchable VALUES ('19c43512-b40e-4e94-be82-b3fc8823a6d1', 'name', NULL) ON CONFLICT DO NOTHING;
INSERT INTO "half_orm_meta.api".field_access_searchable VALUES ('15c51cc1-d55a-463c-bd48-1aa1003eb036', 'email', NULL) ON CONFLICT DO NOTHING;
...
\unrestrict lAzBKpFVxq4Lncdg5NADEXdMieEnGBSd9Hf0X30gA3eClcK73jtCfYzNyJdhx1H
...
UPDATE "half_orm_meta.api".field SET label_order = 1 WHERE schema_name = 'half_orm_meta.identity' AND table_name = 'user' AND column_name = 'email';
